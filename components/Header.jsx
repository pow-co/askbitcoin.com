...
import { Drawer, UserIcon, WalletProviderPopUp} from '.'
...
const Header = () => {
  const { authenticated, avatar, setWallet, authenticate, paymail } = useBitcoin()
        ...
        <div className="px-4 lg:px-7 h-[50px] lg:h-16 relative flex justify-between items-center">
          ...
          <div className='hidden lg:flex grow justify-end items-center'>
            ...
            {/* </Link> */}
              ...
              onClick={login}
              className='ml-4 px-5 w-fit transition duration-500 transform hover:-translate-y-1 h-8 text-base leading-4 text-white font-semibold border-none rounded-md bg-gradient-to-tr from-blue-500 to-blue-600 flex justify-center items-center cursor-pointer relative '>
