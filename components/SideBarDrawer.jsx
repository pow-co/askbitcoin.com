...
const SideBarDrawer = () => {
  ...
  return (
    <div className="fixed  inset-0 w-9/12 h-screen ">
        <div className='py-6 items-center bg-gray-200 dark:bg-gray-800 w-full h-full flex flex-col'>
            ...
            <div className='flex flex-col w-full'>
                ...
                {/* <Link href="/academy">
                    <div className='mt-4 flex items-center cursor-pointer px-5 rounded-md xl:rounded-none hover:transition-all hover:bg-gray-300 hover:dark:bg-gray-700 h-8 xl:h-[48px]'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
